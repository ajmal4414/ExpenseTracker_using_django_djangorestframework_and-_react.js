...
//         />
//         {/* You can add a date picker or use a library like react-datepicker for date selection */}
//         <input
//           type="date"
//           value={date}
...
//     <div className="mx-auto max-w-md p-4 bg-white rounded shadow-lg">
//       <h1 className="text-2xl font-bold mb-4"><br></br>Add Expense</h1>
